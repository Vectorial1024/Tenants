...
namespace Tenants
{
    public class MapComponent_Tenants : MapComponent {
        ...
        public bool Broadcast { get => broadcast; set => broadcast = value; }
        public bool BroadcastCourier { get => broadcastCourier; set => broadcastCourier = value; }
        public int KilledCourier { get => killedCourier; set => killedCourier = value; }
