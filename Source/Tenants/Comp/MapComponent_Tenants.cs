...
namespace Tenants
{
    public class MapComponent_Tenants : MapComponent
    {
        ...
        private List<Pawn> deadTenantsToAvenge = new();
        private List<Pawn> capturedTenantsToAvenge = new();
        private List<Pawn> moles = new();
        private List<Pawn> wantedTenants = new();
        private List<Thing> outgoingMail = new();
        private List<Thing> incomingMail = new();
        private List<Thing> courierCost = new();
        private float karma;
