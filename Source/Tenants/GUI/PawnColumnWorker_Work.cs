...
namespace Tenants
{
    public class PawnColumnWorker_FireFight : PawnColumnWorker_Checkbox
    {
        ...
        protected override void SetValue(Pawn pawn, bool value)
        {
            ...
            if (value && !pawn.story.DisabledWorkTagsBackstoryAndTraits.OverlapsWithOnAnyWorkType(WorkTags.Firefighting))
            {
    ...
    public class PawnColumnWorker_Hauling : PawnColumnWorker_Checkbox
    {
        ...
        {
            Tenant tenantComp = pawn.GetTenantComponent();
            if (value && !(pawn.story.DisabledWorkTagsBackstoryAndTraits.OverlapsWithOnAnyWorkType(WorkTags.ManualDumb) || pawn.story.DisabledWorkTagsBackstoryAndTraits.OverlapsWithOnAnyWorkType(WorkTags.Hauling)))
            {
    ...
    public class PawnColumnWorker_Cleaning : PawnColumnWorker_Checkbox
    {
        ...
        {
            Tenant tenantComp = pawn.GetTenantComponent();
            if (value && !(pawn.story.DisabledWorkTagsBackstoryAndTraits.OverlapsWithOnAnyWorkType(WorkTags.ManualDumb) || pawn.story.DisabledWorkTagsBackstoryAndTraits.OverlapsWithOnAnyWorkType(WorkTags.Cleaning)))
            {
